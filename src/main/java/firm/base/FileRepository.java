...
public class FileRepository<T extends BaseEntity> implements BaseRepository<T> {
    ...
    public T save(T entity) throws IOException {
        ...
        getEntities().add(generateId(entity));
        writeFile();
        return entity;
    }
    ...
    private List<T> getEntities() throws IOException {
        if (entities == null) {
            entities = readFile();
        }
        return entities;
